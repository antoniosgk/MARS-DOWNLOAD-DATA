...
# Choose ONE:
RUN_DATE_YYYYMMDD: Optional[str] = "20260228"  # e.g. "20260114" (if set, overrides offset)
...
ABS_MIN_BYTES = 1_000          # raise if you expect bigger domains
REL_MIN_FACTOR = 0.001          # fail if file is <0.1% of rough expected size (when expected is large)
