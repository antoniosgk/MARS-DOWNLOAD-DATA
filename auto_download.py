...
REGNAME = "GL"
EXPVER = "icki"  #or 0001 or ilrf OR icki
...
LEVELIST: Optional[str] = "110/to/113"  # e.g. "110/to/137" for pl/ml if applicable
...
RUN_DATE_OFFSET_DAYS = 15   #HOW MANY DAYS BACK IN TIME YOU WANT TO DOWNLOAD?0 MEANS TODAY
