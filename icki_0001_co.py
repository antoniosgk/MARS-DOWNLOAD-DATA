...
# SETTINGS
# ============================================================
rdata_path = "/home/agkiokas/CAMS/aekkkkk_ff1_DJF_2025_co.Rdata"
...
for run_name in run_names:
    ...
    csv_path = os.path.join(
        output_base,
        f"{run_name}_co_EU_aek_g4e2_name_nc.csv"
    )
...
for run_name in run_names:
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            ...
            "description": "CO EU DJF 2026 station-interpolated model data",
